...
TABLE_NAME = os.environ.get('TABLE_NAME')  # DynamoDB Table name for storing feedback
BUCKET_NAME = os.environ.get('BUCKET_NAME')  # S3 bucket name for storing feedback attachments
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL')  # Admin email to receive notifications
REGION = os.environ.get('REGION','us-east-2')  # AWS region for resources
